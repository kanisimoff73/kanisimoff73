...
<!-- TODO-IST:START -->
* [x] Разработать Todoist телеграм-бота @WLB_wishlistbot
* [ ] Написать персонального помощника по финансам на FastAPI
* [ ] Разобраться и понять, что такое асинхронное программирование и где его можно применять
<!-- TODO-IST:END -->
