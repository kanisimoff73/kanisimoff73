...
<!-- TODO-IST:START -->
* [x] Изучить основы парсинга, для использования его в последующем проекте
* [x] Закончить пет-проект на фреймворке Django и задеплоить его
* [ ] Пройти курс по фреймворку FastAPI
<!-- TODO-IST:END -->
